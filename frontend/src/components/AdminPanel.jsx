...
export function AdminPanel({ user, onNavigate, onLogout }) {
  ...
  const mockUsers = [
    ...
    { id: 'STU001', name: 'Tom Brown', email: 'tom@student.com', role: 'student', department: 'Computer Science', status: 'Active', joinDate: '2024-05-12' },
    { id: 'STU002', name: 'Emily Davis', email: 'emily@student.com', role: 'student', department: 'Business', status: 'Inactive', joinDate: '2024-06-08' },
  ];
