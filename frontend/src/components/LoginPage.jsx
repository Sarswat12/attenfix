...
export function LoginPage({ onLogin, onBack }) {
  // Backend base URL: can be set with Vite env var VITE_API_BASE, defaults to localhost:5000
  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      setError((err && err.body && err.body.error) || (err && err.body && err.body.message) || 'Failed to register. Please try again.');
    } finally {
      setIsLoading(false);
    }
  };
