...
This is a **web-based Face Recognition Attendance System** that uses facial recognition technology to automatically mark attendance for employees and students. Instead of manual attendance or ID cards, users register their face once, and the system recognizes them automatically when they enter an area.

### Key Features

- **User Authentication**: Secure login/registration with role-based access
- **Face Registration**: Users can capture multiple face images (minimum 5, maximum 7) for accurate recognition
- **Attendance Marking**: Employees/students can mark attendance through face recognition
...
│   │   ├── Sidebar.jsx              # Left sidebar (employee/student)
...
```json
{
  ...
  "role": "employee"  // "admin", "employee", or "student"
}
```
...
- `role`: filter by role ("employee", "student", "admin")
...
```
users
├── id (VARCHAR 20, PRIMARY KEY) - e.g., "EMP001", "STU001"
├── name (VARCHAR 100)
├── email (VARCHAR 100, UNIQUE)
├── password_hash (VARCHAR 255)
├── role (ENUM: 'admin', 'employee', 'student')
...
- **'employee'** or **'student'**: Routes to Employee Dashboard, Regular Sidebar
